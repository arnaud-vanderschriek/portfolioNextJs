    ...
    <div className="my-64">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full ">
        <motion.div 
          ...
          className="absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light md:w-[2px] md:left-[18px] xs:left-[20px]"
        /> 
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-4">
          ...
          <Details   
            ...
            As a fullstack developer, we have to maintain the platform, add new features and allow the user to have a good user interface experience."
          />      
          <Details   
            position="Fullstack developer" 
            company="LaGuimbarde"
